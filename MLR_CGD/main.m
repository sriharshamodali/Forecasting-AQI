...
[J, grad]=costfunction(theta,inputs_train,target);
options = optimset('MaxIter', 500);

initial_theta = randomlyinitializeweights(size(inputs_train,2),1);

[theta, cost]=fmincg(@(t)(costfunction(t,inputs_train, target)), initial_theta, options);
...
R_test=correlation(target_test, pred_test_org)
